          ...
          <div className="p-4">
            <div className="grid lg:grid-cols-3 gap-8 px-2">
              ...
              <div className=" bg-[#FCFCFC] shadow-lg space-y-12 p-4 rounded-xl ">
                ...
                <button className="bg-[#3D61FF] py-1 rounded-md text-white w-full text-sm">
                  {" "}
                  Get Started
                </button>
              </div>
              ...
              <div className="shadow-lg space-y-12 p-4 rounded-xl border border-blue-600 ">
                <div className="space-y-4">
                  ...
                  <p className="">
                    <span className="text-3xl font-bold">$25</span> / month
                  </p>
                  <p className="text-sm opacity-60">
                ...
                <button className="bg-[#3D61FF] py-1 rounded-md text-white text-sm w-full">
                  {" "}
                  Get Started
                </button>
              </div>
              ...
              <div className="shadow-lg bg-[#FCFCFC]  space-y-12 p-4 rounded-xl ">
                ...
                <button className="bg-[#3D61FF] py-1 rounded-md w-full text-white text-sm">
                  {" "}
                  Contact Sales
                </button>
              </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 px-2">
              ...
              <div className="shadow-lg space-y-12 p-4 rounded-xl border border-blue-600 ">
                <div className="space-y-4">
                  ...
                  <p className="">
                    <span className="text-3xl font-bold">$250</span> / month
                  </p>
                  <p className="text-sm opacity-60">
                    Perfect for owners of small & medium businessess
                  </p>
